...
module_param_named(disable_watchdog, rtl8723e_mod_params.disable_watchdog,
		   bool, 0444);
module_param_named(int_clear, rtl8723e_mod_params.int_clear, bool, 0444);
...
MODULE_PARM_DESC(int_clear, "Set to 1 to enable interrupt clear before set (default 0)\n");
