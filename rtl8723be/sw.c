...
int rtl8723be_init_sw_vars(struct ieee80211_hw *hw)
{
	...
	rtlpriv->phy.iqk_inprogress = false;
	...
	rtlpci->ant_sel = rtlpriv->cfg->mod_params->ant_sel;
...
MODULE_PARM_DESC(ant_sel, "Set to 1 or 2 to force antenna selection (default 0)\n");
