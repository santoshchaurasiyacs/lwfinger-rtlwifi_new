			...
			if (v1 & BIT(31)) {/* positive condition*/
				...
				if (cond == COND_ENDIF) {/*end*/
					...
					if (skipped)
						...
						if (_rtl8723be_check_positive(hw, v1, v2)) {
							matched = true;
							skipped = true;
						} else {
							matched = false;
						     ...
						     u8 configtype)
{
	...
	if (configtype == BASEBAND_CONFIG_PHY_REG)
		return __rtl8723be_phy_config_with_headerfile(hw,
				RTL8723BEPHY_REG_1TARRAY, RTL8723BEPHY_REG_1TARRAYLEN,
				_rtl8723be_config_bb_reg);
	else if (configtype == BASEBAND_CONFIG_AGC_TAB)
		return __rtl8723be_phy_config_with_headerfile(hw,
				RTL8723BEAGCTAB_1TARRAY, RTL8723BEAGCTAB_1TARRAYLEN,
					     ...
					     enum radio_path rfpath)
{
	...
	case RF90_PATH_A:
		return __rtl8723be_phy_config_with_headerfile(hw,
				RTL8723BE_RADIOA_1TARRAY, RTL8723BE_RADIOA_1TARRAYLEN,
