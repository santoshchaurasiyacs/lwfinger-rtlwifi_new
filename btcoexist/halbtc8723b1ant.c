...
void halbtc8723b1ant_set_sw_penalty_tx_rate_adaptive(struct btc_coexist
...
void halbtc8723b1ant_lps_rpwm(struct btc_coexist *btcoexist,
...
void halbtc8723b1ant_set_fw_pstdma(struct btc_coexist *btcoexist,
...
void halbtc8723b1ant_ps_tdma(struct btc_coexist *btcoexist,
...
void halbtc8723b1ant_tdma_duration_adjust_for_acl(struct btc_coexist
...
void halbtc8723b1ant_action_bt_sco_hid_only_busy(struct btc_coexist
		*btcoexist, u8 wifi_status)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
	bool	wifi_connected = false;
...
void halbtc8723b1ant_action_wifi_connected_bt_acl_busy(struct btc_coexist
		*btcoexist, u8 wifi_status)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8723b1ant_action_wifi_not_connected_scan(struct btc_coexist
		*btcoexist)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8723b1ant_action_wifi_connected_scan(struct btc_coexist
		*btcoexist)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8723b1ant_init_hw_config(struct btc_coexist *btcoexist,
...
void halbtc8723b1ant_psd_show_antenna_detect_result(struct btc_coexist
		*btcoexist)
{
...
bool halbtc8723b1ant_psd_sweep_point(struct btc_coexist *btcoexist,
		u32 cent_freq, s32 offset, u32 span, u32 points,
...
void halbtc8723b1ant_psd_antenna_detection_check(struct btc_coexist
		*btcoexist)
{
...
void ex_halbtc8723b1ant_scan_notify(struct btc_coexist *btcoexist,
				    u8 type)
{
...
void ex_halbtc8723b1ant_connect_notify(struct btc_coexist *btcoexist,
				       u8 type)
{
	bool	wifi_connected = false, bt_hs_on = false;
	u32	wifi_link_status = 0;
...
void ex_halbtc8723b1ant_pnp_notify(struct btc_coexist *btcoexist,
				   u8 pnp_state)
{
