...
u8 halbtc8821a2ant_wifi_rssi_state(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_limited_rx(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_dec_bt_pwr(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_rf_shrink(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_set_sw_penalty_tx_rate_adaptive(struct btc_coexist
...
void halbtc8821a2ant_set_dac_swing_reg(struct btc_coexist *btcoexist,
				       u32 level)
{
	u8	val = (u8)level;
...
void halbtc8821a2ant_set_sw_full_time_dac_swing(struct btc_coexist
...
void halbtc8821a2ant_dac_swing(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_agc_table(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_set_coex_table(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_coex_table(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_set_lps_rpwm(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_lps_rpwm(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_set_fw_pstdma(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_ps_tdma(struct btc_coexist *btcoexist,
...
void halbtc8821a2ant_power_save_state(struct btc_coexist *btcoexist,
...
bool halbtc8821a2ant_action_wifi_idle_process(struct btc_coexist
		*btcoexist)
{
	u8		wifi_rssi_state, wifi_rssi_state1, bt_rssi_state;
	u8		ap_num = 0;
...
void halbtc8821a2ant_init_hw_config(struct btc_coexist *btcoexist,
				    bool back_up)
{
	u8	u8tmp = 0;
...
void ex_halbtc8821a2ant_scan_notify(struct btc_coexist *btcoexist,
				    u8 type)
{
	u8	u8tmpa, u8tmpb;
...
void ex_halbtc8821a2ant_connect_notify(struct btc_coexist *btcoexist,
				       u8 type)
{
...
void ex_halbtc8821a2ant_pnp_notify(struct btc_coexist *btcoexist,
				   u8 pnp_state)
{
