...
void halbtc8723b2ant_limited_rx(struct btc_coexist *btcoexist,
...
void halbtc8723b2ant_set_sw_penalty_tx_rate_adaptive(struct btc_coexist
...
void halbtc8723b2ant_set_sw_full_time_dac_swing(struct btc_coexist
...
void halbtc8723b2ant_set_lps_rpwm(struct btc_coexist *btcoexist,
...
void halbtc8723b2ant_lps_rpwm(struct btc_coexist *btcoexist,
...
void halbtc8723b2ant_set_fw_pstdma(struct btc_coexist *btcoexist,
...
#if 0
bool halbtc8723b2ant_CoexSwitchThresCheck(struct btc_coexist *btcoexist)
{
	static u8	prewifi_rssi_state = BTC_RSSI_STATE_LOW;
...
void halbtc8723b2ant_ps_tdma(struct btc_coexist *btcoexist,
...
void halbtc8723b2ant_power_save_state(struct btc_coexist *btcoexist,
...
bool halbtc8723b2ant_action_wifi_idle_process(struct btc_coexist
		*btcoexist)
{
	static u8	prewifi_rssi_state = BTC_RSSI_STATE_LOW,
			prewifi_rssi_state1 = BTC_RSSI_STATE_LOW;
...
void halbtc8723b2ant_init_hw_config(struct btc_coexist *btcoexist,
				    bool back_up)
{
	u8	u8tmp = 0;
	u32	 vendor;
...
void ex_halbtc8723b2ant_scan_notify(struct btc_coexist *btcoexist,
				    u8 type)
{
	u32	u32tmp;
	u8	u8tmpa, u8tmpb;
...
void ex_halbtc8723b2ant_connect_notify(struct btc_coexist *btcoexist,
				       u8 type)
{
...
void ex_halbtc8723b2ant_pnp_notify(struct btc_coexist *btcoexist,
				   u8 pnp_state)
{
