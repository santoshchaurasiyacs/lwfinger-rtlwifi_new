...
u8 halbtc8812a1ant_wifi_rssi_state(struct btc_coexist *btcoexist,
	   u8 index, u8 level_num, u8 rssi_thresh, u8 rssi_thresh1)
{
	s32			wifi_rssi = 0;
...
void halbtc8812a1ant_update_ra_mask(struct btc_coexist *btcoexist,
...
void halbtc8812a1ant_auto_rate_fallback_retry(struct btc_coexist *btcoexist,
...
/* to check 0x42a ?? */
void halbtc8812a1ant_retry_limit(struct btc_coexist *btcoexist,
				 bool force_exec, u8 type)
{
...
/* to check 0x456?? */
void halbtc8812a1ant_ampdu_max_time(struct btc_coexist *btcoexist,
				    bool force_exec, u8 type)
{
...
void halbtc8812a1ant_limited_tx(struct btc_coexist *btcoexist,
		bool force_exec, u8 ra_mask_type, u8 arfr_type,
...
void halbtc8812a1ant_limited_rx(struct btc_coexist *btcoexist,
...
void halbtc8812a1ant_query_bt_info(struct btc_coexist *btcoexist)
{
	u8	data_len = 3;
	u8	buf[5] = {0};
...
void halbtc8812a1ant_monitor_bt_ctr(struct btc_coexist *btcoexist)
{
...
/* to check registers */
void halbtc8812a1ant_monitor_wifi_ctr(struct btc_coexist *btcoexist)
{
	s32	wifi_rssi = 0;
...
bool halbtc8812a1ant_is_wifi_status_changed(struct btc_coexist *btcoexist)
{
...
void halbtc8812a1ant_update_bt_link_info(struct btc_coexist *btcoexist)
{
...
u8 halbtc8812a1ant_action_algorithm(struct btc_coexist *btcoexist)
{
	struct  btc_bt_link_info	*bt_link_info = &btcoexist->bt_link_info;
	bool				bt_hs_on = false;
...
void halbtc8812a1ant_set_bt_auto_report(struct btc_coexist *btcoexist,
...
void halbtc8812a1ant_bt_auto_report(struct btc_coexist *btcoexist,
...
/* to check */
void halbtc8812a1ant_set_sw_penalty_tx_rate_adaptive(struct btc_coexist
...
void halbtc8812a1ant_low_penalty_ra(struct btc_coexist *btcoexist,
...
void halbtc8812a1ant_set_coex_table(struct btc_coexist *btcoexist,
...
void halbtc8812a1ant_coex_table(struct btc_coexist *btcoexist,
...
void halbtc8812a1ant_coex_table_with_type(struct btc_coexist *btcoexist,
		bool force_exec, u8 type)
{
	BTC_SPRINTF(trace_buf, BT_TMP_BUF_SIZE,
		    "[BTCoex], ********** CoexTable(%d) **********\n", type);
...
void halbtc8812a1ant_set_fw_ignore_wlan_act(struct btc_coexist *btcoexist,
		bool enable)
{
	u8	data_len = 3;
	u8	buf[5] = {0};
...
void halbtc8812a1ant_ignore_wlan_act(struct btc_coexist *btcoexist,
...
void halbtc8812a1ant_set_lps_rpwm(struct btc_coexist *btcoexist,
...
void halbtc8812a1ant_lps_rpwm(struct btc_coexist *btcoexist,
...
void halbtc8812a1ant_sw_mechanism(struct btc_coexist *btcoexist,
				  bool low_penalty_ra)
{
...
/* to check force_exec */
void halbtc8812a1ant_set_ant_path(struct btc_coexist *btcoexist,
	  u8 ant_pos_type, bool force_exec, bool init_hwcfg,
				  bool wifi_off)
{
	u8			u8tmp = 0;
...
void halbtc8812a1ant_set_fw_pstdma(struct btc_coexist *btcoexist,
...
void halbtc8812a1ant_ps_tdma(struct btc_coexist *btcoexist,
...
bool halbtc8812a1ant_is_common_action(struct btc_coexist *btcoexist)
{
...
void halbtc8812a1ant_tdma_duration_adjust_for_acl(struct btc_coexist
		*btcoexist, u8 wifi_status)
{
...
void halbtc8812a1ant_power_save_state(struct btc_coexist *btcoexist,
...
void halbtc8812a1ant_action_wifi_only(struct btc_coexist *btcoexist)
{
...
void halbtc8812a1ant_monitor_bt_enable_disable(struct btc_coexist *btcoexist)
{
...
/*
void halbtc8812a1ant_action_sco(struct btc_coexist* btcoexist)
{
	halbtc8812a1ant_sw_mechanism(btcoexist, true);
}


void halbtc8812a1ant_action_hid(struct btc_coexist* btcoexist)
{
	halbtc8812a1ant_sw_mechanism(btcoexist, true);
}


void halbtc8812a1ant_action_a2dp(struct btc_coexist* btcoexist)
{
	halbtc8812a1ant_sw_mechanism(btcoexist, false);
}

void halbtc8812a1ant_action_a2dp_pan_hs(struct btc_coexist* btcoexist)
{
	halbtc8812a1ant_sw_mechanism(btcoexist, false);
}

void halbtc8812a1ant_action_pan_edr(struct btc_coexist* btcoexist)
{
	halbtc8812a1ant_sw_mechanism(btcoexist, false);
}


void halbtc8812a1ant_action_pan_hs(struct btc_coexist* btcoexist)
{
	halbtc8812a1ant_sw_mechanism(btcoexist, false);
}


void halbtc8812a1ant_action_pan_edr_a2dp(struct btc_coexist* btcoexist)
{
	halbtc8812a1ant_sw_mechanism(btcoexist, false);
}

void halbtc8812a1ant_action_pan_edr_hid(struct btc_coexist* btcoexist)
{
	halbtc8812a1ant_sw_mechanism(btcoexist, true);
}


void halbtc8812a1ant_action_hid_a2dp_pan_edr(struct btc_coexist* btcoexist)
{
	halbtc8812a1ant_sw_mechanism(btcoexist, true);
}

void halbtc8812a1ant_action_hid_a2dp(struct btc_coexist* btcoexist)
{
	halbtc8812a1ant_sw_mechanism(btcoexist, true);
}
 ...
 *
 * ********************************************* */
void halbtc8812a1ant_action_wifi_multi_port(struct btc_coexist *btcoexist)
{
...
void halbtc8812a1ant_action_hs(struct btc_coexist *btcoexist)
{
	halbtc8812a1ant_ps_tdma(btcoexist, NORMAL_EXEC, true, 5);
	halbtc8812a1ant_coex_table_with_type(btcoexist, NORMAL_EXEC, 2);
}

void halbtc8812a1ant_action_bt_inquiry(struct btc_coexist *btcoexist)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8812a1ant_action_bt_sco_hid_only_busy(struct btc_coexist
		*btcoexist, u8 wifi_status)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
	bool	wifi_connected = false;
...
void halbtc8812a1ant_action_wifi_connected_bt_acl_busy(struct btc_coexist
		*btcoexist, u8 wifi_status)
{
	u8		bt_rssi_state;
...
void halbtc8812a1ant_action_wifi_not_connected(struct btc_coexist *btcoexist)
{
	/* power save state */
	halbtc8812a1ant_power_save_state(btcoexist, BTC_PS_WIFI_NATIVE, 0x0,
					 0x0);
...
void halbtc8812a1ant_action_wifi_not_connected_scan(struct btc_coexist
		*btcoexist)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8812a1ant_action_wifi_connected_scan(struct btc_coexist
		*btcoexist)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8812a1ant_action_wifi_connected(struct btc_coexist *btcoexist)
{
	bool	wifi_busy = false;
...
void halbtc8812a1ant_run_sw_coexist_mechanism(struct btc_coexist *btcoexist)
{
	u8				algorithm = 0;
...
void halbtc8812a1ant_run_coexist_mechanism(struct btc_coexist *btcoexist)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8812a1ant_init_coex_dm(struct btc_coexist *btcoexist)
{
...
void halbtc8812a1ant_init_hw_config(struct btc_coexist *btcoexist,
...
void ex_halbtc8812a1ant_pre_load_firmware(struct btc_coexist *btcoexist)
{
}

void ex_halbtc8812a1ant_init_hw_config(struct btc_coexist *btcoexist,
				       bool wifi_only)
{
...
void ex_halbtc8812a1ant_scan_notify(struct btc_coexist *btcoexist,
				    u8 type)
{
	bool wifi_connected = false, bt_hs_on = false;
	u32	wifi_link_status = 0;
...
void ex_halbtc8812a1ant_connect_notify(struct btc_coexist *btcoexist,
				       u8 type)
{
	bool	wifi_connected = false, bt_hs_on = false;
	u32	wifi_link_status = 0;
...
/* to check registers... */
void ex_halbtc8812a1ant_media_status_notify(struct btc_coexist *btcoexist,
		u8 type)
{
	u8			data_len = 5;
	u8			buf[6] = {0};
...
void ex_halbtc8812a1ant_specific_packet_notify(struct btc_coexist *btcoexist,
		u8 type)
{
	bool	bt_hs_on = false;
	u32	wifi_link_status = 0;
...
void ex_halbtc8812a1ant_rf_status_notify(struct btc_coexist *btcoexist,
		u8 type)
{
...
void ex_halbtc8812a1ant_pnp_notify(struct btc_coexist *btcoexist,
				   u8 pnp_state)
{
...
void ex_halbtc8812a1ant_coex_dm_reset(struct btc_coexist *btcoexist)
{
	BTC_SPRINTF(trace_buf, BT_TMP_BUF_SIZE,
...
void ex_halbtc8812a1ant_dbg_control(struct btc_coexist *btcoexist,
