...
u8 halbtc8821a1ant_wifi_rssi_state(struct btc_coexist *btcoexist,
...
void halbtc8821a1ant_retry_limit(struct btc_coexist *btcoexist,
				 bool force_exec, u8 type)
{
...
void halbtc8821a1ant_limited_tx(struct btc_coexist *btcoexist,
 ...
 * false/false/x: 64
 * false/ture/x:x */
void halbtc8821a1ant_limited_rx(struct btc_coexist *btcoexist,
...
void halbtc8821a1ant_set_sw_penalty_tx_rate_adaptive(struct btc_coexist
...
void halbtc8821a1ant_set_coex_table(struct btc_coexist *btcoexist,
...
void halbtc8821a1ant_coex_table(struct btc_coexist *btcoexist,
...
void halbtc8821a1ant_set_fw_pstdma(struct btc_coexist *btcoexist,
...
void halbtc8821a1ant_set_lps_rpwm(struct btc_coexist *btcoexist,
...
void halbtc8821a1ant_lps_rpwm(struct btc_coexist *btcoexist,
...
void halbtc8821a1ant_ps_tdma(struct btc_coexist *btcoexist,
...
void halbtc8821a1ant_power_save_state(struct btc_coexist *btcoexist,
...
void halbtc8821a1ant_action_bt_sco_hid_only_busy(struct btc_coexist
...
void halbtc8821a1ant_action_wifi_connected_bt_acl_busy(struct btc_coexist
		*btcoexist, u8 wifi_status)
{
	u8		bt_rssi_state;
...
void halbtc8821a1ant_action_wifi_not_connected_scan(struct btc_coexist
		*btcoexist)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8821a1ant_action_wifi_connected_scan(struct btc_coexist
		*btcoexist)
{
	struct  btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8821a1ant_init_hw_config(struct btc_coexist *btcoexist,
...
void ex_halbtc8821a1ant_scan_notify(struct btc_coexist *btcoexist,
				    u8 type)
{
	bool wifi_connected = false, bt_hs_on = false;
	u32	wifi_link_status = 0;
...
void ex_halbtc8821a1ant_connect_notify(struct btc_coexist *btcoexist,
				       u8 type)
{
	bool	wifi_connected = false, bt_hs_on = false;
	u32	wifi_link_status = 0;
...
void ex_halbtc8821a1ant_pnp_notify(struct btc_coexist *btcoexist,
				   u8 pnp_state)
{
	bool wifi_under_5g = false;
