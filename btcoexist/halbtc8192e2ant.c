...
u8 halbtc8192e2ant_wifi_rssi_state(struct btc_coexist *btcoexist,
...
u32 halbtc8192e2ant_decide_ra_mask(struct btc_coexist *btcoexist,
...
void halbtc8192e2ant_retry_limit(struct btc_coexist *btcoexist,
				 bool force_exec, u8 type)
{
...
void halbtc8192e2ant_dec_bt_pwr(struct btc_coexist *btcoexist,
...
void halbtc8192e2ant_set_sw_penalty_tx_rate_adaptive(struct btc_coexist
...
void halbtc8192e2ant_set_dac_swing_reg(struct btc_coexist *btcoexist,
				       u32 level)
{
	u8	val = (u8)level;
...
void halbtc8192e2ant_set_sw_full_time_dac_swing(struct btc_coexist
...
void halbtc8192e2ant_dac_swing(struct btc_coexist *btcoexist,
...
void halbtc8192e2ant_agc_table(struct btc_coexist *btcoexist,
...
void halbtc8192e2ant_coex_table(struct btc_coexist *btcoexist,
...
void halbtc8192e2ant_set_fw_pstdma(struct btc_coexist *btcoexist,
...
void halbtc8192e2ant_init_hw_config(struct btc_coexist *btcoexist,
				    bool back_up)
{
	u16	u16tmp = 0;
	u8	u8tmp = 0;
...
void ex_halbtc8192e2ant_scan_notify(struct btc_coexist *btcoexist,
				    u8 type)
{
...
void ex_halbtc8192e2ant_connect_notify(struct btc_coexist *btcoexist,
				       u8 type)
{
