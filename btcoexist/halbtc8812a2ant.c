...
u8 halbtc8812a2ant_wifi_rssi_state(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_monitor_bt_enable_disable(struct btc_coexist *btcoexist)
{
...
u32 halbtc8812a2ant_decide_ra_mask(struct btc_coexist *btcoexist,
				   u32 ra_mask_type)
{
	u32	dis_ra_mask = 0x0;
...
void halbtc8812a2ant_update_ra_mask(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_auto_rate_fallback_retry(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_retry_limit(struct btc_coexist *btcoexist,
				 bool force_exec, u8 type)
{
...
void halbtc8812a2ant_ampdu_max_time(struct btc_coexist *btcoexist,
				    bool force_exec, u8 type)
{
...
void halbtc8812a2ant_limited_tx(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_limited_rx(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_monitor_bt_ctr(struct btc_coexist *btcoexist)
{
...
void halbtc8812a2ant_query_bt_info(struct btc_coexist *btcoexist)
{
	u8	data_len = 3;
	u8	buf[5] = {0};
...
bool halbtc8812a2ant_is_wifi_status_changed(struct btc_coexist *btcoexist)
{
...
void halbtc8812a2ant_update_bt_link_info(struct btc_coexist *btcoexist)
{
...
u8 halbtc8812a2ant_action_algorithm(struct btc_coexist *btcoexist)
{
	struct  btc_bt_link_info	*bt_link_info = &btcoexist->bt_link_info;
	struct  btc_stack_info	*stack_info = &btcoexist->stack_info;
	bool				bt_hs_on = false;
...
void halbtc8812a2ant_set_fw_dac_swing_level(struct btc_coexist *btcoexist,
		u8 dac_swing_lvl)
{
...
void halbtc8812a2ant_set_fw_dec_bt_pwr(struct btc_coexist *btcoexist,
				       u8 dec_bt_pwr_lvl)
{
	u8	data_len = 4;
	u8	buf[6] = {0};
...
void halbtc8812a2ant_dec_bt_pwr(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_fw_dac_swing_lvl(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_set_sw_rf_rx_lpf_corner(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_rf_shrink(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_set_sw_penalty_tx_rate_adaptive(struct btc_coexist
...
void halbtc8812a2ant_low_penalty_ra(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_set_dac_swing_reg(struct btc_coexist *btcoexist,
				       u32 level)
{
	u8	val = (u8)level;
...
void halbtc8812a2ant_set_sw_full_time_dac_swing(struct btc_coexist
		*btcoexist, bool sw_dac_swing_on, u32 sw_dac_swing_lvl)
{
	if (sw_dac_swing_on)
...
void halbtc8812a2ant_dac_swing(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_set_adc_back_off(struct btc_coexist *btcoexist,
				      bool adc_back_off)
{
	if (adc_back_off) {
		BTC_SPRINTF(trace_buf, BT_TMP_BUF_SIZE,
...
void halbtc8812a2ant_adc_back_off(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_set_agc_table(struct btc_coexist *btcoexist,
				   bool agc_table_en)
{
...
void halbtc8812a2ant_agc_table(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_set_coex_table(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_coex_table(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_coex_table_with_type(struct btc_coexist *btcoexist,
		bool force_exec, u8 type)
{
	switch (type) {
	case 0:
...
void halbtc8812a2ant_set_fw_ignore_wlan_act(struct btc_coexist *btcoexist,
		bool enable)
{
	u8	data_len = 3;
	u8	buf[5] = {0};
...
void halbtc8812a2ant_ignore_wlan_act(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_set_fw_pstdma(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_set_lps_rpwm(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_lps_rpwm(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_sw_mechanism1(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_sw_mechanism2(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_set_ant_path(struct btc_coexist *btcoexist,
	  u8 ant_pos_type, bool init_hwcfg, bool wifi_off)
{
	u8			u8tmp = 0;
...
void halbtc8812a2ant_ps_tdma(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_coex_all_off(struct btc_coexist *btcoexist)
{
	/* fw all off */
...
void halbtc8812a2ant_init_coex_dm(struct btc_coexist *btcoexist)
{
...
void halbtc8812a2ant_power_save_state(struct btc_coexist *btcoexist,
		      u8 ps_type, bool low_pwr_disable, u8 lps_val,
				      u8 rpwm_val)
{
	switch (ps_type) {
...
void halbtc8812a2ant_action_bt_inquiry(struct btc_coexist *btcoexist)
{
...
bool halbtc8812a2ant_is_common_action(struct btc_coexist *btcoexist)
{
	struct  btc_bt_link_info	*bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8812a2ant_tdma_duration_adjust(struct btc_coexist *btcoexist,
...
void halbtc8812a2ant_get_bt_rssi_threshold(struct btc_coexist *btcoexist,
		u8 *pThres0, u8 *pThres1)
{
	u8 ant_type;
...
void halbtc8812a2ant_action_sco(struct btc_coexist *btcoexist)
{
...
void halbtc8812a2ant_action_sco_hid(struct btc_coexist *btcoexist)
{
	u8		wifi_rssi_state = BTC_RSSI_STATE_HIGH,
			bt_rssi_state = BTC_RSSI_STATE_HIGH;
	u32		wifi_bw;
...
void halbtc8812a2ant_action_hid(struct btc_coexist *btcoexist)
{
	u8		wifi_rssi_state = BTC_RSSI_STATE_HIGH,
			bt_rssi_state = BTC_RSSI_STATE_HIGH;
	u32		wifi_bw;
...
void halbtc8812a2ant_action_a2dp(struct btc_coexist *btcoexist)
{
	u8		wifi_rssi_state = BTC_RSSI_STATE_HIGH,
			bt_rssi_state = BTC_RSSI_STATE_HIGH;
	u32		wifi_bw;
...
void halbtc8812a2ant_action_a2dp_pan_hs(struct btc_coexist *btcoexist)
{
	u8		wifi_rssi_state = BTC_RSSI_STATE_HIGH,
			bt_rssi_state = BTC_RSSI_STATE_HIGH;
	u32		wifi_bw;
...
void halbtc8812a2ant_action_pan_edr(struct btc_coexist *btcoexist)
{
	u8		wifi_rssi_state = BTC_RSSI_STATE_HIGH,
			bt_rssi_state = BTC_RSSI_STATE_HIGH;
	u32		wifi_bw;
...
/* PAN(HS) only */
void halbtc8812a2ant_action_pan_hs(struct btc_coexist *btcoexist)
{
	u8		wifi_rssi_state = BTC_RSSI_STATE_HIGH,
			bt_rssi_state = BTC_RSSI_STATE_HIGH;
	u32		wifi_bw;
...
/* PAN(EDR)+A2DP */
void halbtc8812a2ant_action_pan_edr_a2dp(struct btc_coexist *btcoexist)
{
	u8		wifi_rssi_state = BTC_RSSI_STATE_HIGH,
			bt_rssi_state = BTC_RSSI_STATE_HIGH;
	u32		wifi_bw;
...
void halbtc8812a2ant_action_pan_edr_hid(struct btc_coexist *btcoexist)
{
	u8		wifi_rssi_state = BTC_RSSI_STATE_HIGH,
			bt_rssi_state = BTC_RSSI_STATE_HIGH;
	u32		wifi_bw;
...
/* HID+A2DP+PAN(EDR) */
void halbtc8812a2ant_action_hid_a2dp_pan_edr(struct btc_coexist *btcoexist)
{
	u8		wifi_rssi_state = BTC_RSSI_STATE_HIGH,
			bt_rssi_state = BTC_RSSI_STATE_HIGH;
	u32		wifi_bw;
...
void halbtc8812a2ant_action_hid_a2dp_pan_hs(struct btc_coexist *btcoexist)
{
	u8		wifi_rssi_state = BTC_RSSI_STATE_HIGH,
			bt_rssi_state = BTC_RSSI_STATE_HIGH;
	u32		wifi_bw;
...
void halbtc8812a2ant_action_hid_a2dp(struct btc_coexist *btcoexist)
{
	u8		wifi_rssi_state = BTC_RSSI_STATE_HIGH,
			bt_rssi_state = BTC_RSSI_STATE_HIGH;
	u32		wifi_bw;
...
void halbtc8812a2ant_coex_under_5g(struct btc_coexist *btcoexist)
{
...
/* **************************************************** */
void halbtc8812a2ant_run_coexist_mechanism(struct btc_coexist *btcoexist)
{
...
void halbtc8812a2ant_init_hw_config(struct btc_coexist *btcoexist,
				    bool back_up)
{
	u8	u8tmp = 0;
