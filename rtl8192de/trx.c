		...
		bool bpacket_toself, bool packet_beacon)
{
	...
	if (is_cck) {
		...
		pstatus->recvsignalpower = rx_pwr_all;
		if (pstatus->is_ht && pstatus->rate >= DESC92D_RATEMCS8 &&
...
void rtl92de_set_desc(struct ieee80211_hw *hw, u8 *pdesc,
...
u32 rtl92de_rx_command_packet(struct ieee80211_hw *hw,
