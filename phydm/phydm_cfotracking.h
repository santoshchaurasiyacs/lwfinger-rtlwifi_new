...
void phydm_set_crystal_cap(void *p_dm_void, u8 crystal_cap);

void phydm_cfo_tracking_init(void *p_dm_void);

void phydm_cfo_tracking(void *p_dm_void);

void phydm_parsing_cfo(void *p_dm_void, void *p_pktinfo_void, s8 *pcfotail,
		       u8 num_ss);
